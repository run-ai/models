docker build --build-arg ORGANIZATION=NousResearch --build-arg MODEL=Llama-2-7b-chat-hf --build_arg SAFETENSORS_ONLY=True-t gcr.io/run-ai-demo/quickstart-inference:Llama-2-7b-chat-hf .
...
docker rmi docker push gcr.io/run-ai-demo/quickstart-inference:falcon-40b-instruct
